      ...
      <div className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
        <div className="grid gap-5 row-gap-8 lg:grid-cols-2">
          <div className="flex flex-col justify-center">
            <div className="max-w-xl mb-6">
              ...
              <p className="text-base text-gray-700 md:text-lg">
                Our sites are so trusted that you will love to see our analytics
                on previous year.it was great that we are providing great
                service and owning trus of people
              </p>
            </div>
            <a
              href="/"
          ...
          <div className="relative">
            <svg
              className="absolute w-full text-cyan-500"
              fill="currentColor"
              viewBox="0 0 600 392"
            >
            ...
            <svg
              className="relative w-full text-blue-500"
              fill="currentColor"
              viewBox="0 0 600 392"
            >
